...
Lưu ý: `.env` thường ngày của frontend đang trỏ tới `http://192.168.1.155:8080/api/v1`, nhưng host đó không online lúc bắt đầu test. Bản web test được chạy với override `EXPO_PUBLIC_API_URL=http://localhost:8080/api/v1`.
