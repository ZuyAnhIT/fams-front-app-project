...
- `GET http://192.168.1.115:8080/api/v1/auth/health`: hoạt động qua LAN.
...
| Cấu hình | Trạng thái |
|---|---|
| `EXPO_PUBLIC_API_URL` | Đã cấu hình tới `http://192.168.1.115:8080/api/v1` |
...
curl http://192.168.1.115:8080/api/v1/auth/health
```
